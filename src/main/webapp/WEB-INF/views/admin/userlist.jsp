				...
				<div>사용자 관리</div>
                    ...
                    <c:forEach var="vo" items="${userList }">
                    	<tr>
                            ...
                            <td><input type="button" class="listEdit-btn" value="수정" onclick="location.href='/admin/profile?id=${vo.id }'"> / <input type="button" class="listDel-btn" id = "listDel"value="삭제" onclick="location.href='/admin/listDel?id=${vo.id }'"></td>
