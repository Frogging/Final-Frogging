...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#courseForm").submit(function(){
			...
			$.ajax({
				type : 'POST',
				url : '/maps/tmapsEditOk/${course.course_no}',
				data : {"lat": lat, "log": lon, "distance" : tDistance, "time" : tTime, "course_name" : course_name, "course_info" : course_info, "address" : address},
